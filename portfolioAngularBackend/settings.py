...
# Adresse qui recevra les messages du formulaire de contact
CONTACT_RECIPIENT_EMAIL = os.environ.get("CONTACT_RECIPIENT_EMAIL", EMAIL_HOST_USER or DEFAULT_FROM_EMAIL)